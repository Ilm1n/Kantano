...
- Redis-кеширование доски, участников и тегов с проверкой доступа через PostgreSQL;
...
между backend-процессами через Redis Pub/Sub. Повторное чтение доски, участников и
тегов обслуживается через Redis-кеш после обязательной проверки членства в PostgreSQL;
инвалидация выполняется после commit соответствующей мутации.
